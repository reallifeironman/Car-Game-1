...
class CarRacing:
    ...
    def initialize(self):
        ...
        # enemy_car
        self.enemy_car = pygame.image.load('enemy car1.png')
        self.enemy_car_startx = random.randrange(310, 450)
        self.enemy_car_starty = -600
        self.enemy_car_speed = 55555
        self.enemy_car_width = 49
        self.enemy_car_height = 100

         # enemy_car
        self.enemy_car = pygame.image.load('enemy car2.png')
        self.enemy_car_startx = random.randrange(310, 450)
        self.enemy_car_starty = -600
        ...
        # Background
        self.bgImg = pygame.image.load("street.jpg")
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- Anshuman')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Anshuman Bahekar", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("anshumanbahekar14@gmail.com", True, self.white)
